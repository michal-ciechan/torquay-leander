...
**Championships programme design** — the live page lists the 2026 programme as session cards. [I've mocked up three more modern treatments](https://michal-ciechan.github.io/torquay-leander/samples/club-championships/) — a timeline, calendar-style date tiles, and a colour-coded stroke × distance grid that answers "when is my event?" at a glance — plus a comparison of full event names vs the short ones from your email. Tell me which layout (and naming) you prefer and I'll make it live.
