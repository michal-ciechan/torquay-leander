...
- **Swim England logo + link in the footer** (the footer already says "Swim England Affiliated" in text).
- **Home page** — compressing the hero banner, and replacing "Upcoming Meets" with a **News** feed from the club Facebook page.
...
2. **Swim England logo** — do you have a preferred official asset/brand file, or shall we take the standard one from swimming.org?
3. **Swim Torquay link** — what's the best web address (or contact) for the Learn to Swim stages 1–4 button?
4. **Facebook feed** — happy for us to embed the club page feed directly, or would you rather we hand-pick posts as "News"?
5. **Warm-up video & stretches** — where does that content live (YouTube links, PDFs, something else)?
6. **Video titles** — a few of the YouTube links you sent have no obvious titles; if you have names for them it'll make the training video section tidier.
