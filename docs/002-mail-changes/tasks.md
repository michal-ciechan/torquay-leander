...
- [x] **Tab — Warm-up video** — Add a Warm Up Video tab (content TBD / linked from mail assets if provided). *(done as a **Warm-Up section** in the hub — re-reading the mail, Dom meant picks from the same Swim England playlist his links came from: added Supple Strength Warm-Up (idx 26), Mobility for Turns (66) and Streamlining Mobility for Young Swimmers (57) alongside Mobility for Starts)*
- [x] **Tab — Stretches** — Add a Stretches tab (content TBD / linked from mail assets if provided). *(done as a **Stretches section** in the hub — arms & shoulders (45), plus Hamstrings (60) and Splits (59) flexibility sessions from the same playlist)*
...
- [x] Confirm where Warm-up / Stretches media lives. *(resolved — the media lives in the same Swim England playlist as all his other links; warm-up and stretches videos picked from it)*
